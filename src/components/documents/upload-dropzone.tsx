      ...
      >
        ...
        <div className="space-y-1 mb-4 max-w-sm">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
            Upload PDFs, Word docs, TXT, or images. Files sync automatically to Google Drive.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2">
          <span className="px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-slate-800 text-[11px] font-mono font-medium text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700">
            📄 PDF • DOCX • TXT • MD
          </span>
